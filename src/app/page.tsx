        ...
        {!authReady || (userId && !ready) ? (
          ...
          <>
            ...
            <section className="table-stage">
              <Scoreboard session={room.session} members={room.members} canKick={host} onKick={(playerId) => setConfirmation({ title: "Espellere questo giocatore?", message: "Il posto torner� disponibile e lo storico della partita rester� invariato.", confirmLabel: "Espelli giocatore", tone: "danger", onConfirm: () => void kickPlayer(playerId) })} />
